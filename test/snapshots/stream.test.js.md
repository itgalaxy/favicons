# Snapshot report for `test/stream.test.js`
...
> Snapshot 1

    {
      images: [
        ...
        {
          contents: Image<manifest.json>,
          name: 'manifest.json',
        },
        {
          contents: Image<manifest.webapp>,
          name: 'manifest.webapp',
        },
        {
          contents: Image<browserconfig.xml>,
          name: 'browserconfig.xml',
        },
        {
          contents: Image<yandex-browser-manifest.json>,
