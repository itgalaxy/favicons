...
module.exports = {
  ...
  appleStartup: [
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(width: 320px) and (height: 480px) and (-webkit-device-pixel-ratio: 1)" href="${relative("apple-touch-startup-image-320x460.png")}">`,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(width: 320px) and (height: 480px) and (-webkit-device-pixel-ratio: 2)" href="${relative("apple-touch-startup-image-640x920.png")}">`,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(width: 320px) and (height: 568px) and (-webkit-device-pixel-ratio: 2)" href="${relative("apple-touch-startup-image-640x1096.png")}">`,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(width: 375px) and (height: 667px) and (-webkit-device-pixel-ratio: 2)" href="${relative("apple-touch-startup-image-750x1294.png")}">`,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(width: 414px) and (height: 736px) and (orientation: landscape) and (-webkit-device-pixel-ratio: 3)" href="${relative("apple-touch-startup-image-1182x2208.png")}">`,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(width: 414px) and (height: 736px) and (orientation: portrait) and (-webkit-device-pixel-ratio: 3)" href="${relative("apple-touch-startup-image-1242x2148.png")}">`,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(width: 768px) and (height: 1024px) and (orientation: landscape) and (-webkit-device-pixel-ratio: 1)" href="${relative("apple-touch-startup-image-748x1024.png")}">`,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(width: 768px) and (height: 1024px) and (orientation: portrait) and (-webkit-device-pixel-ratio: 1)" href="${relative("apple-touch-startup-image-768x1004.png")}">`,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(width: 768px) and (height: 1024px) and (orientation: landscape) and (-webkit-device-pixel-ratio: 2)" href="${relative("apple-touch-startup-image-1496x2048.png")}">`,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(width: 768px) and (height: 1024px) and (orientation: portrait) and (-webkit-device-pixel-ratio: 2)" href="${relative("apple-touch-startup-image-1536x2008.png")}">`
  ],
  coast: [
