...
module.exports = {
  ...
  appleStartup: [
    ...
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(device-width: 768px) and (device-height: 1024px) and (orientation: portrait) and (-webkit-device-pixel-ratio: 2)" href="${relative("apple-touch-startup-image-2008x1536.png")}">`,
    ...
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(device-width: 414px) and (device-height: 736px) and (orientation: portrait) and (-webkit-device-pixel-ratio: 3)" href="${relative("apple-touch-startup-image-1242x2208.png")}">`,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(device-width: 414px) and (device-height: 736px) and (orientation: landscape) and (-webkit-device-pixel-ratio: 3)" href="${relative("apple-touch-startup-image-2208x1242.png")}"> `,
    ...
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(device-width: 375px) and (device-height: 812px) and (orientation: landscape) and (-webkit-device-pixel-ratio: 3)" href="${relative("apple-touch-startup-image-2436x1125.png")}">`,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(device-width: 414px) and (device-height: 896px) and (orientation: portrait) and (-webkit-device-pixel-ratio: 2)" href="${relative("apple-touch-startup-image-828x1792.png")}"> `,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(device-width: 414px) and (device-height: 896px) and (orientation: landscape) and (-webkit-device-pixel-ratio: 2)" href="${relative("apple-touch-startup-image-1792x828.png")}">`,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(device-width: 414px) and (device-height: 896px) and (orientation: portrait) and (-webkit-device-pixel-ratio: 3)" href="${relative("apple-touch-startup-image-1242x2688.png")}"> `,
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(device-width: 414px) and (device-height: 896px) and (orientation: landscape) and (-webkit-device-pixel-ratio: 3)" href="${relative("apple-touch-startup-image-2688x1242.png")}">`
  ],
  coast: [
