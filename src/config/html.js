...
module.exports = {
  ...
  appleStartup: [
    ...
    ({ relative }) => `<link rel="apple-touch-startup-image" media="(device-width: 414px) and (device-height: 736px) and (orientation: landcape) and (-webkit-device-pixel-ratio: 3)" href="${relative("apple-touch-startup-image-2208x1242.png")}"> `,
